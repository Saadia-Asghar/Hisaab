...
import { randomAvatarColor, signInWithGoogle } from '../lib/ensureProfile'
...
export default function Signup() {
  ...
  async function onSubmit(e) {
    ...
    if (!isFirebaseConfigured || !auth || !db) {
      setError('Add Firebase keys to .env.local, or use the interactive demo from the home page.')
      return
    }
    setBusy(true)
    try {
